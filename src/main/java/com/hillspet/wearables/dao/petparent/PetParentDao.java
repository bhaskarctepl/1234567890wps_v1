...
public interface PetParentDao {
	...
	String getPetParentListCount(PetParentFilter filter) throws ServiceExecutionException;

	List<PetParentListDTO> getPetParents() throws ServiceExecutionException;

	List<PetParentListDTO> getPetParentList(PetParentFilter filter) throws ServiceExecutionException;
