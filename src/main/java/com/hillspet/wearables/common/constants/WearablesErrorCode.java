...
public enum WearablesErrorCode implements ErrorDetailInterface, EnumInterface<String> {
	...
	ADDRESS_REQUIRED("WEARABLES_REQ_ERR_011", THREE, WearablesMessageKey.ADDRESS_REQUIRED, BAD_REQUEST),
	...
	PET_PARENT_EMAIL_ALREADY_EXISTS("WEARABLES_INVAL_ERR_057", THREE, WearablesMessageKey.PET_PARENT_EMAIL_ALREADY_EXISTS, BAD_REQUEST),
	PET_PARENT_SECONDARY_EMAIL_ALREADY_EXISTS("WEARABLES_INVAL_ERR_20", THREE, WearablesMessageKey.PET_PARENT_SECONDARY_EMAIL_ALREADY_EXISTS, BAD_REQUEST),
	...
	STUDY_DIET_ALREADY_MAPPED_CANNOT_DELETE("WEARABLES_INVAL_ERR_060", THREE, WearablesMessageKey.STUDY_DIET_ALREADY_MAPPED_CANNOT_DELETE, BAD_REQUEST),
	...
	INVALID_ADDRESS("WEARABLES_INVAL_ERR_052", THREE, WearablesMessageKey.INVALID_ADDRESS, BAD_REQUEST),
	
	QUESTIONNAIRE_CATEGORY_ALREADY_EXISTS("WEARABLES_INVAL_ERR_058", THREE, WearablesMessageKey.QUESTIONNAIRE_CATEGORY_ALREADY_EXISTS, BAD_REQUEST),
	QUESTIONNAIRE_CATEGORY_ALREADY_MAPPED("WEARABLES_INVAL_ERR_059", THREE, WearablesMessageKey.QUESTIONNAIRE_CATEGORY_ALREADY_MAPPED, BAD_REQUEST),
	...
	STUDY_FEEDING_SCHEDULE_ALREADY_EXISTS("WEARABLES_INVAL_ERR_061", THREE, WearablesMessageKey.STUDY_FEEDING_SCHEDULE_ALREADY_EXISTS, BAD_REQUEST),
	STUDY_UPDATE_STATUS_DRAFT("WEARABLES_INVAL_ERR_062", THREE, WearablesMessageKey.STUDY_UPDATE_STATUS_DRAFT, BAD_REQUEST),
	STUDY_UPDATE_STATUS_SCHEDULED("WEARABLES_INVAL_ERR_063", THREE, WearablesMessageKey.STUDY_UPDATE_STATUS_SCHEDULED, BAD_REQUEST),
	STUDY_UPDATE_STATUS_INPROGRESS("WEARABLES_INVAL_ERR_064", THREE, WearablesMessageKey.STUDY_UPDATE_STATUS_INPROGRESS, BAD_REQUEST),	
	STUDY_UPDATE_STATUS_FINALIZE_GROUPS("WEARABLES_INVAL_ERR_066", THREE, WearablesMessageKey.STUDY_UPDATE_STATUS_FINALIZE_GROUPS, BAD_REQUEST),
	STUDY_UPDATE_MANDATORY_CHECK_FAIL("WEARABLES_INVAL_ERR_067", THREE, WearablesMessageKey.STUDY_UPDATE_MANDATORY_CHECK_FAIL, BAD_REQUEST),
	STUDY_MOVE_TO_NEXT_PHASE_NO_STUDY_NEXT_PHASE("WEARABLES_INVAL_ERR_068", THREE, WearablesMessageKey.STUDY_MOVE_TO_NEXT_PHASE_NO_STUDY_NEXT_PHASE, BAD_REQUEST),
	STUDY_MOVE_TO_NEXT_PHASE_NO_PET_NEXT_PHASE("WEARABLES_INVAL_ERR_069", THREE, WearablesMessageKey.STUDY_MOVE_TO_NEXT_PHASE_NO_PET_NEXT_PHASE, BAD_REQUEST),
	STUDY_MOVE_TO_NEXT_PHASE_PET_INVALID_MOVE_DATE("WEARABLES_INVAL_ERR_070", THREE, WearablesMessageKey.STUDY_MOVE_TO_NEXT_PHASE_PET_INVALID_MOVE_DATE, BAD_REQUEST),
	STUDY_MAX_PETS_IN_TREATMENT_GROUP_VALIDATION_FAILED("WEARABLES_INVAL_ERR_071", THREE, WearablesMessageKey.STUDY_MAX_PETS_IN_TREATMENT_GROUP_VALIDATION_FAILED, BAD_REQUEST),
	STUDY_FEEDING_SCHEDULE_VALIDATION_FAILED("WEARABLES_INVAL_ERR_072", THREE, WearablesMessageKey.STUDY_FEEDING_SCHEDULE_VALIDATION_FAILED, BAD_REQUEST),
	STUDY_REMOVE_PET_INVALID_DATE("WEARABLES_INVAL_ERR_073", THREE, WearablesMessageKey.STUDY_REMOVE_PET_INVALID_DATE, BAD_REQUEST),
	STUDY_REMOVE_PET_INVALID_PHASE_DAY("WEARABLES_INVAL_ERR_074", THREE, WearablesMessageKey.STUDY_REMOVE_PET_INVALID_PHASE_DAY, BAD_REQUEST),
	
	STUDY_EXTEND_PHASE_SCHEDULE_ALREADY_EXISTS("WEARABLES_INVAL_ERR_065", THREE, WearablesMessageKey.FAVOURITE_DOES_NOT_EXISTS, BAD_REQUEST),
	STUDY_PET_CANNOT_ADD_IN_CURRENT_OR_PREVIOUS_PHASES("WEARABLES_INVAL_ERR_075", THREE, WearablesMessageKey.STUDY_PET_CANNOT_ADD_IN_CURRENT_OR_PREVIOUS_PHASES, BAD_REQUEST),
	QUESTIONNAIRE_NAME_INVALID_LENGTH("WEARABLES_INVAL_ERR_076", THREE, WearablesMessageKey.QUESTIONNAIRE_NAME_INVALID_LENGTH, BAD_REQUEST),
	STUDY_QUESTIONNAIRE_CONFIG_INVALID_DATE_RANGE("WEARABLES_INVAL_ERR_077", THREE, WearablesMessageKey.STUDY_QUESTIONNAIRE_CONFIG_INVALID_DATE_RANGE, BAD_REQUEST),
	INVALID_FILE("WEARABLES_INVAL_ERR_078", THREE, WearablesMessageKey.INVALID_FILE, BAD_REQUEST)
	;
