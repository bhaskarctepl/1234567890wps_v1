...
public enum WearablesErrorCode implements ErrorDetailInterface, EnumInterface<String> {
	...
	STUDY_FEEDING_SCHEDULE_VALIDATION_FAILED("WEARABLES_INVAL_ERR_072", THREE, WearablesMessageKey.STUDY_MAX_PETS_IN_TREATMENT_GROUP_VALIDATION_FAILED, BAD_REQUEST),
